...
const tiers = {
  free: { name: 'Free', limits: { accounts: 1, alarms: 2, events: 1, perAccount: { bubbleAlarms: 1, eventAlarms: 1 } }, eur: { weekly: 0, monthly: 0, sixMonth: 0, yearly: 0, lifetime: 0 }, usdDirect: { weekly: 0, monthly: 0, sixMonth: 0, yearly: 0, lifetime: 0 }, usdStore: { weekly: 0, monthly: 0, sixMonth: 0, yearly: 0, lifetime: 0 }, jpyDirect: { weekly: 0, monthly: 0, sixMonth: 0, yearly: 0, lifetime: 0 }, jpyStore: { weekly: 0, monthly: 0, sixMonth: 0, yearly: 0, lifetime: 0 }, annualSavingPercent: null },
  streetBoss: { name: 'Street Boss', limits: { accounts: 2, alarms: 4, events: 2, perAccount: { bubbleAlarms: 1, eventAlarms: 1 } }, eur: { weekly: 4.99, monthly: 14.99, sixMonth: 79.99, yearly: 129.99, lifetime: 199.99 }, usdDirect: { weekly: 5.79, monthly: 17.37, sixMonth: 92.77, yearly: 150.77, lifetime: 231.91 }, usdStore: { weekly: 5.99, monthly: 16.99, sixMonth: 89.99, yearly: 149.99, lifetime: 214.99 }, jpyDirect: { weekly: 924, monthly: 2777, sixMonth: 14815, yearly: 24072, lifetime: 37042 }, jpyStore: { weekly: 1000, monthly: 2800, sixMonth: 14800, yearly: 24000, lifetime: 37000 }, annualSavingPercent: 17 },
  caporegime: { name: 'Caporegime', limits: { accounts: 3, alarms: 6, events: 3, perAccount: { bubbleAlarms: 1, eventAlarms: 1 } }, eur: { weekly: 7.99, monthly: 24.99, sixMonth: 129.99, yearly: 199.99, lifetime: 299.99 }, usdDirect: { weekly: 9.26, monthly: 28.99, sixMonth: 150.72, yearly: 231.83, lifetime: 347.73 }, usdStore: { weekly: 9.99, monthly: 27.99, sixMonth: 149.99, yearly: 229.99, lifetime: 319.99 }, jpyDirect: { weekly: 1479, monthly: 4629, sixMonth: 24077, yearly: 37038, lifetime: 55557 }, jpyStore: { weekly: 1500, monthly: 4600, sixMonth: 24000, yearly: 37000, lifetime: 55000 }, annualSavingPercent: 23 },
  underboss: { name: 'Underboss', limits: { accounts: 5, alarms: 10, events: 5, perAccount: { bubbleAlarms: 1, eventAlarms: 1 } }, eur: { weekly: 9.99, monthly: 34.99, sixMonth: 179.99, yearly: 299.99, lifetime: 449.99 }, usdDirect: { weekly: 11.58, monthly: 40.56, sixMonth: 208.77, yearly: 347.79, lifetime: 521.87 }, usdStore: { weekly: 11.99, monthly: 39.99, sixMonth: 199.99, yearly: 349.99, lifetime: 479.99 }, jpyDirect: { weekly: 1850, monthly: 6483, sixMonth: 33332, yearly: 55552, lifetime: 83358 }, jpyStore: { weekly: 1900, monthly: 6500, sixMonth: 33000, yearly: 56000, lifetime: 83000 }, annualSavingPercent: 17 },
  godfather: { name: 'Godfather', limits: { accounts: Infinity, alarms: Infinity, events: Infinity, perAccount: { bubbleAlarms: Infinity, eventAlarms: Infinity } }, eur: { weekly: 19.99, monthly: 69.99, sixMonth: 399.99, yearly: 599.99, lifetime: 799.99 }, usdDirect: { weekly: 23.18, monthly: 81.1, sixMonth: 463.96, yearly: 695.68, lifetime: 927.64 }, usdStore: { weekly: 22.99, monthly: 79.99, sixMonth: 449.99, yearly: 699.99, lifetime: 899.99 }, jpyDirect: { weekly: 3702, monthly: 12956, sixMonth: 74086, yearly: 111061, lifetime: 148106 }, jpyStore: { weekly: 3700, monthly: 13000, sixMonth: 74000, yearly: 111000, lifetime: 148000 }, annualSavingPercent: 17 },
};

const tierOrder = ['free', 'streetBoss', 'caporegime', 'underboss', 'godfather'];
const tierFeatures = {
  free: ['1 Account', '1 Bubble-Alarm pro Account', '1 Event-Alarm pro Account', 'Alle drei Gaming-Töne'],
...
const sourcePricing = source.match(/const TIER_PRICING = \{.*?\n  \};\n  const TIER_FEATURES/s);
...
console.log('Synchronized web pricing: five tiers, EUR/USD/JPY price data.');
