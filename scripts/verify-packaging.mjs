...
for (const ref of [
  ...
  'icon.png',
  'styles.css?v=10',
  'styles-accessibility.css?v=1',
  'reference-theme.css?v=4',
  'reference-theme-global.css?v=3',
  'reference-theme-final.css?v=1',
  'founder-access.js?v=4',
  'founder-runtime.js?v=1',
...
if (!runtime.includes("const SOURCE_URL = './app.js?v=26';")) {
  throw new Error('Packaged founder runtime does not point to the current app asset.');
}
