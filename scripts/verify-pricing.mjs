...
const tiers = {
  ...
  boss: { eur: [14.99, 49.99, 249.99, 399.99, 599.99], usdStore: [16.99, 54.99, 299.99, 499.99, 699.99], jpyStore: [2800, 10000, 50000, 78000, 115000] },
...
assert(js.includes("const TIER_ORDER = ['free','streetBoss','caporegime','underboss','boss','godfather'];"), 'Six-tier order is missing.');
...
assert(js.includes("usdStore:{weekly:16.99,monthly:54.99,sixMonth:299.99,yearly:499.99,lifetime:699.99}"), 'Boss USD Store pricing mismatch.');
