(() => {
  ...
  const TIER_PRICING = {
    ...
    streetBoss: { name: 'Street Boss', limits: { accounts: 2, alarms: 4, events: 2, perAccount: { bubbleAlarms: 1, eventAlarms: 1 } }, eur: { weekly: 4.99, monthly: 14.99, sixMonth: 79.99, yearly: 129.99, lifetime: 199.99 }, usdDirect: { weekly: 5.79, monthly: 17.39, sixMonth: 92.79, yearly: 150.79, lifetime: 231.99 }, usdStore: { weekly: 4.99, monthly: 16.99, sixMonth: 84.99, yearly: 139.99, lifetime: 214.99 }, annualSavingPercent: 25 },
    caporegime: { name: 'Caporegime', limits: { accounts: 3, alarms: 6, events: 3, perAccount: { bubbleAlarms: 1, eventAlarms: 1 } }, eur: { weekly: 7.99, monthly: 24.99, sixMonth: 129.99, yearly: 199.99, lifetime: 299.99 }, usdDirect: { weekly: 9.27, monthly: 28.99, sixMonth: 150.79, yearly: 231.99, lifetime: 347.99 }, usdStore: { weekly: 7.99, monthly: 27.99, sixMonth: 139.99, yearly: 214.99, lifetime: 319.99 }, annualSavingPercent: 33 },
    godfather: { name: 'Godfather', limits: { accounts: Infinity, alarms: Infinity, events: Infinity, perAccount: { bubbleAlarms: Infinity, eventAlarms: Infinity } }, eur: { weekly: 12.99, monthly: 39.99, sixMonth: 214.99, yearly: 319.99, lifetime: 499.99 }, usdDirect: { weekly: 15.07, monthly: 46.39, sixMonth: 231.99, yearly: 347.99, lifetime: 579.99 }, usdStore: { weekly: 12.99, monthly: 44.99, sixMonth: 229.99, yearly: 349.99, lifetime: 529.99 }, annualSavingPercent: 33 },
  };
  const TIER_FEATURES = {
