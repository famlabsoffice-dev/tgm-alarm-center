(() => {
  ...
  function renderAlarmModal(id, templateKey) {
    ...
    const template = templateKey === 'gw' ? { type: 'gw', title: 'GW-Zeitfenster', warnings: [60, 30, 15], repeat: 'once', sound: 'siren', protected: true } : templateKey === 'individual' ? { type: 'individual', title: 'Individual-Alarm', warnings: [15], repeat: 'once', sound: 'chime', protected: false } : templateKey === 'rss' ? { type: 'rss', title: 'RSS-Alarm', warnings: [15], repeat: 'once', sound: 'chime', protected: false } : templateKey === 'custom' ? { type: 'custom', title: 'Mein TGM-Event', warnings: [15], repeat: 'once', sound: 'chime', protected: false } : { type: 'bubble', title: 'Bubble-Zeitfenster', warnings: [60, 15], repeat: 'once', sound: 'pulse', protected: true };
